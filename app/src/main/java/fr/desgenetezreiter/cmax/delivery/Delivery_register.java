...
public class Delivery_register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TILemail = findViewById(R.id.delivery_register_mail);
        TILpassword = findViewById(R.id.delivery_register_password);
        TILlastname = findViewById(R.id.delivery_register_lastname);
        TILfirstname = findViewById(R.id.delivery_register_firstname);
        TILphone = findViewById(R.id.delivery_register_phone);
        TILstreet = findViewById(R.id.delivery_register_street);
        TILcity = findViewById(R.id.delivery_register_city);
        TILzip = findViewById(R.id.delivery_register_postal);
        TILcountry = findViewById(R.id.delivery_register_country);
    ...
    private void register(){
        ...
        RegisterModel registerModel = new RegisterModel(email,password,first_name,last_name,phone,addressModel,RegisterModel.TYPE_DELIVERER);
